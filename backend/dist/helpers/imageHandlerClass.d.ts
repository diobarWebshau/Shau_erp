...
declare class ImageHandler {
     ...
     */
    static moveImageToEntityDirectory(relativePath: string, entity: string, entityId: string): Promise<string>;
    /**
     ...
     */
    static removeImageIfExists(relativePath: string): Promise<void>;
    /**
     ...
     */
    static doesImageExist(relativePath: string): Promise<boolean>;
    /**
     ...
     */
    static convertToBase64(relativePath: string): Promise<string | null>;
    /**
     ...
     */
    static removePathIfExists(relativePath: string): Promise<void>;
}
