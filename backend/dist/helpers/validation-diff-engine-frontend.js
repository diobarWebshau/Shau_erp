...
exports.ChildConfigBuilder = exports.ChildConfigRootBuilder = void 0;
...
async function diffObjects(a, b, opts = defaultDiffOpts) {
...
async function diffObjectArrays(arr1, arr2, opts = defaultDiffOpts) {
...
async function diffObjectArraysWithChildSingle(arr1, arr2, options) {
    const { childKey, managerKey, parentDiffOpts = defaultDiffOpts, childDiffOpts = defaultDiffOpts, } = options;
    // Diff base de padres
...
// ============================================================
async function diffObjectArraysWithChildMulti(arr1, arr2, configs, parentDiffOpts = defaultDiffOpts) {
...
// --------------------------------------------------------------
async function diffObjectArraysWithChildren(arr1, arr2, configs, parentDiffOpts = defaultDiffOpts) {
    const base = await diffObjectArrays(arr1, arr2, parentDiffOpts);
    const added = [];
    const modified = [];
...
async function deepDiff(a, b, opts = defaultDiffOpts) {
