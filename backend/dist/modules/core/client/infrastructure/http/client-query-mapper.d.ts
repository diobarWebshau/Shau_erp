import { GetAllClientsSchema } from "./../../application/dto/client.endpoint.schema";
import type { ClientSearchCriteria } from "../../domain/client.types";
/**
 ...
 */
export declare const mapClientQueryToCriteria: (query: GetAllClientsSchema["query"]) => ClientSearchCriteria;
