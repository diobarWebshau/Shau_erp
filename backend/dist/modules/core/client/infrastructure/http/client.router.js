...
const ClientRouter = () => {
    ...
    router.get("/", (0, zod_middleware_1.validateRequest)(client_endpoint_schema_1.getAllClientsSchema), controller.getAll);
    router.get("/id/:id", (0, zod_middleware_1.validateRequest)(client_endpoint_schema_1.getByIdClientSchema), controller.getById);
    router.get("/company_name/:company_name", (0, zod_middleware_1.validateRequest)(client_endpoint_schema_1.getByCompanyNameClientSchema), controller.getByCompanyName);
    router.post("/", (0, zod_middleware_1.validateRequest)(client_endpoint_schema_1.createClientSchema), controller.create);
    router.patch("/:id", (0, zod_middleware_1.validateRequest)(client_endpoint_schema_1.updateClientSchema), controller.update);
    router.delete("/:id", (0, zod_middleware_1.validateRequest)(client_endpoint_schema_1.deleteClientSchema), controller.delete);
    return router;
};
