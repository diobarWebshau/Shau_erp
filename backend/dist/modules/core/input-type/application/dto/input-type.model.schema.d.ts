 ...
 */
declare const inputTypeCreateSchema: z.ZodObject<{
    name: z.ZodString;
}, z.core.$strip>;
/**
 * UpdateSchema
 ...
 */
declare const inputTypeUpdateSchema: z.ZodObject<{
 ...
 */
declare const inputTypeResponseSchema: z.ZodObject<{
    id: z.ZodNumber;
    name: z.ZodString;
 ...
 */
type InputTypeCreateDto = z.infer<typeof inputTypeCreateSchema>;
type InputTypeUpdateDto = z.infer<typeof inputTypeUpdateSchema>;
type InputTypeResponseDto = z.infer<typeof inputTypeResponseSchema>;
export { inputTypeCreateSchema, inputTypeResponseSchema, inputTypeUpdateSchema };
export type { InputTypeCreateDto, InputTypeResponseDto, InputTypeUpdateDto };
