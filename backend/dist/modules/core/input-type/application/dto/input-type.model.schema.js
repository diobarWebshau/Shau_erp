...
exports.inputTypeUpdateSchema = exports.inputTypeResponseSchema = exports.inputTypeCreateSchema = void 0;
 ...
 */
const inputTypeCreateSchema = zod_1.z.object({
    name: zod_1.z.string()
});
exports.inputTypeCreateSchema = inputTypeCreateSchema;
/**
 * UpdateSchema
 * ------------------------------------------------------------------
 ...
 */
const inputTypeUpdateSchema = inputTypeCreateSchema.partial();
exports.inputTypeUpdateSchema = inputTypeUpdateSchema;
/**
 * ResponseSchema
 * ------------------------------------------------------------------
 ...
 */
const inputTypeResponseSchema = zod_1.z.object({
    id: zod_1.z.number().int(),
    name: zod_1.z.string(),
    created_at: zod_1.z.string(),
    updated_at: zod_1.z.string(),
});
exports.inputTypeResponseSchema = inputTypeResponseSchema;
