...
exports.CreateInputTypeUseCase = void 0;
...
class CreateInputTypeUseCase {
    ...
    execute = async (data, tx) => {
        ...
        if (!created)
            throw new http_error_1.default(500, "No fue posible crear el nuevo tipo de insumo.");
        return created;
    };
}
exports.CreateInputTypeUseCase = CreateInputTypeUseCase;
