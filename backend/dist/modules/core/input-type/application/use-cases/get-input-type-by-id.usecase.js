...
exports.GetInputTypeByIdUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetInputTypeByIdUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    async execute(id, tx) {
        return await this.repo.findById(id, tx);
    }
}
exports.GetInputTypeByIdUseCase = GetInputTypeByIdUseCase;
