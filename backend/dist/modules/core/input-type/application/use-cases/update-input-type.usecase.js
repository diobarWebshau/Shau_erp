...
exports.UpdateInputTypeUseCase = void 0;
...
class UpdateInputTypeUseCase {
    ...
    execute = async (id, data, tx) => {
        ...
        if (!Object.keys(updateValues).length)
            return existing;
        const updated = await this.repo.update(Number(id), updateValues, tx);
        if (!updated)
            throw new http_error_1.default(500, "No fue posible actualizar la locación.");
        return updated;
    };
}
exports.UpdateInputTypeUseCase = UpdateInputTypeUseCase;
