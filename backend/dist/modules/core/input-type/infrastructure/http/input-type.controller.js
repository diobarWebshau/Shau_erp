...
exports.InputTypeController = void 0;
// src/modules/Input/infrastructure/http/Input.controller.ts
const get_input_type_by_name_usecase_1 = require("../../application/use-cases/get-input-type-by-name.usecase");
const get_input_type_by_id_usecase_1 = require("../../application/use-cases/get-input-type-by-id.usecase");
const get_all_input_type_usecase_1 = require("../../application/use-cases/get-all-input-type.usecase");
const create_input_type_usecase_1 = require("../../application/use-cases/create-input-type.usecase");
const update_input_type_usecase_1 = require("../../application/use-cases/update-input-type.usecase");
const delete_input_type_usecase_1 = require("../../application/use-cases/delete-input-type.usecase");
const input_type_repository_1 = __importDefault(require("../repository/input-type.repository"));
/**
...
class InputTypeController {
    ...
    deleteUseCase;
    constructor() {
        this.repo = new input_type_repository_1.default();
        this.getAllUseCase = new get_all_input_type_usecase_1.GetAllInputTypesUseCase(this.repo);
        this.getByIdUseCase = new get_input_type_by_id_usecase_1.GetInputTypeByIdUseCase(this.repo);
        this.getByNameUseCase = new get_input_type_by_name_usecase_1.GetInputTypeByNameUseCase(this.repo);
        this.createUseCase = new create_input_type_usecase_1.CreateInputTypeUseCase(this.repo);
        this.updateUseCase = new update_input_type_usecase_1.UpdateInputTypeUseCase(this.repo);
        this.deleteUseCase = new delete_input_type_usecase_1.DeleteInputTypeUseCase(this.repo);
    }
    // ============================================================
...
exports.InputTypeController = InputTypeController;
