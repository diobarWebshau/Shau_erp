 ...
 */
const InputTypeRouter = () => {
    const router = (0, express_1.Router)();
    const controller = new input_type_controller_1.InputTypeController();
    router.get("/", (0, zod_middleware_1.validateRequest)(input_type_endpoint_schema_1.getAllinputTypeSchema), controller.getAll);
    router.get("/id/:id", (0, zod_middleware_1.validateRequest)(input_type_endpoint_schema_1.getByIdinputTypeSchema), controller.getById);
    router.get("/name/:name", (0, zod_middleware_1.validateRequest)(input_type_endpoint_schema_1.getByNameinputTypeSchema), controller.getByName);
    router.post("/", (0, zod_middleware_1.validateRequest)(input_type_endpoint_schema_1.createinputTypeSchema), controller.create);
    router.patch("/:id", (0, zod_middleware_1.validateRequest)(input_type_endpoint_schema_1.updateinputTypeSchema), controller.update);
    router.delete("/:id", (0, zod_middleware_1.validateRequest)(input_type_endpoint_schema_1.deleteinputTypeSchema), controller.delete);
    return router;
};
exports.InputTypeRouter = InputTypeRouter;
