import { GetAllinputsSchema } from "../../application/dto/input.endpoint.schema";
import type { InputSearchCriteria } from "../../domain/input.types";
/**
 ...
 */
export declare const mapInputQueryToCriteria: (query: GetAllinputsSchema["query"]) => InputSearchCriteria;
