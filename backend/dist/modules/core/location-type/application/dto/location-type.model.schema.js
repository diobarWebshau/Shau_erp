...
exports.locationTypeUpdateSchema = exports.locationTypeResponseSchema = exports.locationTypeCreateSchema = void 0;
 ...
 */
const locationTypeCreateSchema = zod_1.z.object({
    name: zod_1.z.string()
});
exports.locationTypeCreateSchema = locationTypeCreateSchema;
/**
 * UpdateSchema
 * ------------------------------------------------------------------
 ...
 */
const locationTypeUpdateSchema = locationTypeCreateSchema.partial();
exports.locationTypeUpdateSchema = locationTypeUpdateSchema;
/**
 * ResponseSchema
 * ------------------------------------------------------------------
...
exports.locationTypeResponseSchema = locationTypeResponseSchema;
