 ...
 */
class CreateLocationTypeUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    execute = async (data) => {
        ...
        if (!created)
            throw new http_error_1.default(500, "No fue posible crear el nuevo tipo de locación.");
        return created;
    };
}
exports.CreateLocationTypeUseCase = CreateLocationTypeUseCase;
