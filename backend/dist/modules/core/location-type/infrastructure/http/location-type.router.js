...
exports.LocationTypeRouter = void 0;
const location_type_endpoint_schema_1 = require("../../application/dto/location-type.endpoint.schema");
 ...
 */
const LocationTypeRouter = () => {
    const router = (0, express_1.Router)();
    const controller = new location_type_controller_1.LocationTypeController();
    router.get("/", (0, zod_middleware_1.validateRequest)(location_type_endpoint_schema_1.getAllLocationTypeSchema), controller.getAll);
    router.get("/id/:id", (0, zod_middleware_1.validateRequest)(location_type_endpoint_schema_1.getByIdLocationTypeSchema), controller.getById);
    router.get("/name/:name", (0, zod_middleware_1.validateRequest)(location_type_endpoint_schema_1.getByNameLocationTypeSchema), controller.getByName);
    router.post("/", (0, zod_middleware_1.validateRequest)(location_type_endpoint_schema_1.createLocationTypeSchema), controller.create);
    router.patch("/:id", (0, zod_middleware_1.validateRequest)(location_type_endpoint_schema_1.updateLocationTypeSchema), controller.update);
    router.delete("/:id", (0, zod_middleware_1.validateRequest)(location_type_endpoint_schema_1.deleteLocationTypeSchema), controller.delete);
    return router;
};
exports.LocationTypeRouter = LocationTypeRouter;
