...
type LocationTypeCreationAttributes = Partial<Omit<LocationTypeAttributes, 'id' | 'created_at' | 'updated_at'>>;
declare class LocationTypeModel extends Model<LocationTypeAttributes, LocationTypeCreationAttributes> {
    id: number;
    name: string;
    created_at: Date;
    updated_at: Date;
    static getAllFields: () => readonly (keyof LocationTypeAttributes)[];
    static getEditableFields: () => readonly (keyof LocationTypeAttributes)[];
}
export { LocationTypeModel };
export type { LocationTypeAttributes, LocationTypeCreationAttributes };
