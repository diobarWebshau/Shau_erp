...
exports.mapLocationQueryToCriteria = void 0;
 ...
 */
const mapLocationQueryToCriteria = (query) => {
    return {
        filter: query?.filter,
        ...
        decription: (0, query_request_normalizer_1.normalizeToArray)(query.description),
...
exports.mapLocationQueryToCriteria = mapLocationQueryToCriteria;
