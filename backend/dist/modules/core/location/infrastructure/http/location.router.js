...
const location_endpoint_schema_1 = require("../../application/dto/location.endpoint.schema");
...
const locationRouter = () => {
    ...
    router.get("/", (0, zod_middleware_1.validateRequest)(location_endpoint_schema_1.getAllLocationsSchema), controller.getAll);
    router.get("/id/:id", (0, zod_middleware_1.validateRequest)(location_endpoint_schema_1.getByIdLocationSchema), controller.getById);
    router.get("/name/:name", (0, zod_middleware_1.validateRequest)(location_endpoint_schema_1.getByNameLocationSchema), controller.getByName);
    router.get("/custom_id/:custom_id", (0, zod_middleware_1.validateRequest)(location_endpoint_schema_1.getByCustomIdLocationSchema), controller.getByCustomId);
    router.post("/", (0, zod_middleware_1.validateRequest)(location_endpoint_schema_1.createLocationSchema), controller.create);
    router.patch("/:id", (0, zod_middleware_1.validateRequest)(location_endpoint_schema_1.updateLocationSchema), controller.update);
    router.delete("/:id", (0, zod_middleware_1.validateRequest)(location_endpoint_schema_1.deleteLocationSchema), controller.delete);
    return router;
};
