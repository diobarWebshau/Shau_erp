...
exports.CreateProcessUseCase = void 0;
...
class CreateProcessUseCase {
    ...
    execute = async (data, tx) => {
        ...
        if (!created)
            throw new http_error_1.default(500, "No fue posible crear el nuevo tipo de proceso.");
        return created;
    };
}
exports.CreateProcessUseCase = CreateProcessUseCase;
