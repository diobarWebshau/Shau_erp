...
type ProcessCreationAttributes = Partial<Omit<ProcessAttributes, 'id' | 'created_at' | 'updated_at'>>;
type ProcessUpdateAttributes = ProcessCreationAttributes;
declare class ProcessModel extends Model<ProcessAttributes, ProcessCreationAttributes> {
    id: number;
    name: string;
    description: string;
    created_at: Date;
    updated_at: Date;
    static getAllFields: () => readonly (keyof ProcessAttributes)[];
    static getEditableFields: () => readonly (keyof ProcessAttributes)[];
}
export { ProcessModel };
export type { ProcessAttributes, ProcessCreationAttributes, ProcessUpdateAttributes };
