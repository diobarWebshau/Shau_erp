...
interface ProductProps {
    ...
    production_cost?: DecimalVO | null;
    storage_conditions?: string | null;
    barcode?: number | null;
    sku?: string | null;
    sale_price?: DecimalVO | null;
    photo?: string | null;
    is_draft: boolean;
    is_active: boolean;
    created_at: Date;
...
type ProductCreateProps = Omit<ProductProps, "id" | "created_at" | "updated_at">;
type ProductUpdateProps = Partial<ProductCreateProps>;
...
export { ProductProps, ProductCreateProps, ProductUpdateProps, ProductSearchCriteria };
