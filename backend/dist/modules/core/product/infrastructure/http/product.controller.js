...
const get_product_by_custom_id_usecase_1 = require("../../application/use-cases/get-product-by-custom-id.usecase");
const get_product_by_barcode_usecase_1 = require("../../application/use-cases/get-product-by-barcode.usecase");
const get_product_by_sku_usecase_1 = require("../../application/use-cases/get-product-by-sku.usecase");
const get_product_by_id_usecase_1 = require("../../application/use-cases/get-product-by-id.usecase");
const get_product_by_name_usecase_1 = require("../../application/use-cases/get-product-by-name.usecase");
const get_all_product_usecase_1 = require("../../application/use-cases/get-all-product.usecase");
...
class ProductController {
    ...
    constructor() {
        ...
        this.getAllUseCase = new get_all_product_usecase_1.GetAllProductsUseCase(this.repo);
        this.getByIdUseCase = new get_product_by_id_usecase_1.GetProductByIdUseCase(this.repo);
        this.getByNameUseCase = new get_product_by_name_usecase_1.GetProductByNameCase(this.repo);
        this.getByBarcodeUseCase = new get_product_by_barcode_usecase_1.GetProductByBarcodeUseCase(this.repo);
        this.getBySkuUseCase = new get_product_by_sku_usecase_1.GetProductBySkuIdUseCase(this.repo);
        this.getByCustomIdUseCase = new get_product_by_custom_id_usecase_1.GetProductByCustomIdUseCase(this.repo);
        this.createUseCase = new create_product_usecase_1.CreateProductUseCase(this.repo);
        this.updateUseCase = new update_product_usecase_1.UpdateProductUseCase(this.repo);
    ...
    update = async (req, res) => {
        ...
        try {
            ...
            if (tmpPhotoPath) {
                finalPhotoPath =
                    await imageHandlerClass_1.default.moveImageToEntityDirectory(tmpPhotoPath, "products", id.toString());
