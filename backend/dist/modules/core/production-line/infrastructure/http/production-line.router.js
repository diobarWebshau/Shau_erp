 ...
 */
const productionLineRouter = () => {
    const router = (0, express_1.Router)();
    const controller = new production_line_controller_1.ProductionLineController();
    router.get("/", (0, zod_middleware_1.validateRequest)(production_lines_endpoint_schema_1.getAllProductionLinesSchema), controller.getAll);
    router.get("/id/:id", (0, zod_middleware_1.validateRequest)(production_lines_endpoint_schema_1.getByIdProductionLineSchema), controller.getById);
    router.get("/name/:name", (0, zod_middleware_1.validateRequest)(production_lines_endpoint_schema_1.getByNameProducionLineSchema), controller.getByName);
    router.get("/custom_id/:custom_id", (0, zod_middleware_1.validateRequest)(production_lines_endpoint_schema_1.getByCustomIdProducionLineSchema), controller.getByCustomId);
    router.post("/", (0, zod_middleware_1.validateRequest)(production_lines_endpoint_schema_1.createProducionLineSchema), controller.create);
    router.patch("/:id", (0, zod_middleware_1.validateRequest)(production_lines_endpoint_schema_1.updateProducionLineSchema), controller.update);
    router.delete("/:id", (0, zod_middleware_1.validateRequest)(production_lines_endpoint_schema_1.deleteProducionLineSchema), controller.delete);
    return router;
};
exports.productionLineRouter = productionLineRouter;
