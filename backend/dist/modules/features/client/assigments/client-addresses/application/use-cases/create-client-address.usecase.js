...
exports.CreateClientAddressUseCase = void 0;
...
class CreateClientAddressUseCase {
    ...
    async execute(data, tx) {
        ...
        if (!created)
            throw new http_error_1.default(500, "No fue posible crear la nueva dirección para el cliente.");
        return created;
    }
}
exports.CreateClientAddressUseCase = CreateClientAddressUseCase;
