...
type ClientAddressCreateProps = Omit<ClientAddressProps, "id" | "created_at" | "updated_at">;
type ClientAddressUpdateProps = Partial<ClientAddressCreateProps>;
export { ClientAddressProps, ClientAddressCreateProps, ClientAddressUpdateProps };
