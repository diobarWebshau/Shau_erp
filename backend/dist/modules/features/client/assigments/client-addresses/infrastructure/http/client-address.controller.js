...
class ClientAddressController {
    ...
    deleteUseCase;
    constructor() {
        this.repoClientAddress = new client_address_repository_1.ClientAddressRepository();
        this.repoClient = new client_repository_1.ClientRepository();
        this.getAllUseCase = new get_all_client_address_usecase_1.GetAllClientAddressesUseCase(this.repoClientAddress);
        this.getByIdUseCase = new get_client_address_by_id_usecase_1.GetClientAddressByIdUseCase(this.repoClientAddress);
        this.getByClientIdUseCase = new get_cllient_address_by_client_id_usecase_1.GetClienAddressByClientIdUseCase(this.repoClientAddress);
        this.createUseCase = new create_client_address_usecase_1.CreateClientAddressUseCase(this.repoClientAddress, this.repoClient);
        this.updateUseCase = new update_client_address_usecase_1.UpdateClientAddressUseCase(this.repoClientAddress);
