...
exports.ClientAddressRouter = void 0;
const client_address_endpoint_schema_1 = require("../../application/dto/client-address.endpoint.schema");
 ...
 * ------------------------------------------------------------------
 * Define las rutas HTTP asociadas al recurso `Client`.
 ...
 * - Delegar la ejecución de cada operación al `ClientController`.
 * - Garantizar tipado estricto en parámetros, body, query y respuesta.
 *
 * Qué hace:
 * - Expone las rutas públicas de la API para `Client`.
 ...
 * - Cada router corresponde a un recurso del sistema (ej. `ClientRouter`).
 ...
 */
const ClientAddressRouter = () => {
    const router = (0, express_1.Router)();
    const controller = new client_address_controller_1.ClientAddressController();
    router.get("/", (0, zod_middleware_1.validateRequest)(client_address_endpoint_schema_1.getAllClientAddressesSchema), controller.getAll);
    router.get("/id/:id", (0, zod_middleware_1.validateRequest)(client_address_endpoint_schema_1.getByIdClientAddressSchema), controller.getById);
    router.get("/client_id/:client_id", (0, zod_middleware_1.validateRequest)(client_address_endpoint_schema_1.getByClientIdClientAddressSchema), controller.getByClientIdName);
    router.post("/", (0, zod_middleware_1.validateRequest)(client_address_endpoint_schema_1.createClientAddressSchema), controller.create);
    router.patch("/:id", (0, zod_middleware_1.validateRequest)(client_address_endpoint_schema_1.updateClientAddressSchema), controller.update);
    router.delete("/:id", (0, zod_middleware_1.validateRequest)(client_address_endpoint_schema_1.deleteClientAddressSchema), controller.delete);
    return router;
};
exports.ClientAddressRouter = ClientAddressRouter;
