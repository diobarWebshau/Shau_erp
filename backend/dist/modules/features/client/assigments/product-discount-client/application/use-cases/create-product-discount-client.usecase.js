...
class CreateProductDiscountClientUseCase {
    ...
    async execute(data) {
        ...
        if (isExistingDiscount) {
            throw new http_error_1.default(409, "Ya existe un descuento del producto para este cliente.");
        }
...
exports.CreateProductDiscountClientUseCase = CreateProductDiscountClientUseCase;
