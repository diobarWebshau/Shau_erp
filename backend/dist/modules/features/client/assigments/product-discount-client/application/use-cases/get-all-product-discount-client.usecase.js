...
exports.GetAllProductDiscountClientUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetAllProductDiscountClientUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
...
exports.GetAllProductDiscountClientUseCase = GetAllProductDiscountClientUseCase;
