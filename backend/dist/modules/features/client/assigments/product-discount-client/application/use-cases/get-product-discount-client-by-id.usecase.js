...
exports.GetProductDiscountClientByIdUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetProductDiscountClientByIdUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
...
exports.GetProductDiscountClientByIdUseCase = GetProductDiscountClientByIdUseCase;
;
