...
type ProductDiscountClientCreateAttributes = Omit<ProductDiscountClientAttributes, "id" | "created_at" | "updated_at">;
type ProductDiscountClientUpdateAttributes = Partial<ProductDiscountClientCreateAttributes>;
declare class ProductDiscountClientModel extends Model<ProductDiscountClientAttributes, ProductDiscountClientCreateAttributes> {
    id: number;
    product_id: number;
    client_id: number;
    discount_percentage: number;
    ...
    static getAllFields: () => readonly (keyof ProductDiscountClientAttributes)[];
}
export { ProductDiscountClientModel };
export type { ProductDiscountClientAttributes, ProductDiscountClientCreateAttributes };
