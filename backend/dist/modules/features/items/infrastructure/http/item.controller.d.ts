...
export declare class ItemController {
    ...
    constructor();
    getAll: (_req: ApiRequest<GetAllItemSchema>, res: ApiResponse<GetAllItemSchema>) => Promise<ApiResponse<GetAllItemSchema>>;
    getById: (req: ApiRequest<GetByIdItemSchema>, res: ApiResponse<GetByIdItemSchema>) => Promise<ApiResponse<GetByIdItemSchema>>;
}
