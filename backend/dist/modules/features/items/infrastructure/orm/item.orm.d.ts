...
type ItemUpdateAttributes = Partial<ItemCreateAttributes>;
declare class ItemModel extends Model<ItemAttributes, ItemCreateAttributes> {
    id: number;
    item_type: "product" | "input";
    item_id: number;
    static getAllAttributes(): (keyof ItemAttributes)[];
}
export { ItemModel };
export type { ItemCreateAttributes, ItemUpdateAttributes, ItemAttributes };
