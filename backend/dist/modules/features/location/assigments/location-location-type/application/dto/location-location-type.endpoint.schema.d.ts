 ...
 * ------------------------------------------------------------------
 */
declare const getByLocationIdLocationTypeIdLocationLocationTypeSchema: z.ZodObject<{
    params: z.ZodObject<{
        location_id: z.ZodString;
        location_type_id: z.ZodString;
    }, z.core.$strip>;
    query: z.ZodObject<{}, z.core.$strict>;
    body: z.ZodObject<{}, z.core.$strict>;
    response: z.ZodNullable<z.ZodObject<{
...
type GetByLocationIdLocationTypeIdLocationLocationTypeSchema = EndpointSchema<z.infer<typeof getByLocationIdLocationTypeIdLocationLocationTypeSchema>["params"], z.infer<typeof getByLocationIdLocationTypeIdLocationLocationTypeSchema>["body"], z.infer<typeof getByLocationIdLocationTypeIdLocationLocationTypeSchema>["query"], z.infer<typeof getByLocationIdLocationTypeIdLocationLocationTypeSchema>["response"]>;
export { deleteLocationLocationTypeSchema, createLocationLocationTypeSchema, getAllLocationLocationTypeSchema, updateLocationLocationTypeSchema, getByIdLocationLocationTypeSchema, getByLocationIdLocationTypeIdLocationLocationTypeSchema };
export type { CreateLocationLocationTypeSchema, GetAllLocationLocationTypesSchema, GetByIdLocationLocationTypeSchema, UpdateLocationLocationTypeSchema, DeleteLocationLocationTypeSchema, GetByLocationIdLocationTypeIdLocationLocationTypeSchema };
