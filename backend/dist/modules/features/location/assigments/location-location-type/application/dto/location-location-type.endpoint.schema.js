...
exports.getByLocationIdLocationTypeIdLocationLocationTypeSchema = exports.getByIdLocationLocationTypeSchema = exports.updateLocationLocationTypeSchema = exports.getAllLocationLocationTypeSchema = exports.createLocationLocationTypeSchema = exports.deleteLocationLocationTypeSchema = void 0;
 ...
 * ------------------------------------------------------------------
 */
const getByLocationIdLocationTypeIdLocationLocationTypeSchema = zod_1.z.object({
    params: zod_1.z.object({ location_id: zod_1.z.string(), location_type_id: zod_1.z.string() }),
    query: zod_1.z.object({}).strict(),
    body: zod_1.z.object({}).strict(),
    response: location_location_type_model_schema_1.locationLocationTypeReponseSchema.nullable(),
});
exports.getByLocationIdLocationTypeIdLocationLocationTypeSchema = getByLocationIdLocationTypeIdLocationLocationTypeSchema;
/**
