...
exports.CreateLocationLocationTypeUseCase = void 0;
 ...
 */
class CreateLocationLocationTypeUseCase {
    repo;
    repoLocation;
    repoLocationType;
    constructor(repo, repoLocation, repoLocationType) {
        this.repo = repo;
...
exports.CreateLocationLocationTypeUseCase = CreateLocationLocationTypeUseCase;
