...
exports.GetAllLocationLocationTypeUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetAllLocationLocationTypeUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
...
exports.GetAllLocationLocationTypeUseCase = GetAllLocationLocationTypeUseCase;
