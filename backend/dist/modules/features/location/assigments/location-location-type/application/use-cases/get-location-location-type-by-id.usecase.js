...
exports.GetLocationLocationTypeByIdUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetLocationLocationTypeByIdUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
...
exports.GetLocationLocationTypeByIdUseCase = GetLocationLocationTypeByIdUseCase;
;
