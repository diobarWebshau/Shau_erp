...
exports.UpdateLocationLocationTypeUseCase = void 0;
 ...
 */
class UpdateLocationLocationTypeUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    async execute(id, data, tx) {
        ...
        if (!updated)
            throw new http_error_1.default(500, "No fue posible actualizar la asignacion del tipo de locacíon a la locación.");
        return updated;
    }
}
exports.UpdateLocationLocationTypeUseCase = UpdateLocationLocationTypeUseCase;
