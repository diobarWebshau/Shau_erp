...
exports.getByLocationProductionLineIdLocationProductionLineSchema = exports.getByIdLocationProductionLineSchema = exports.updateLocationProductionLineSchema = exports.getAllLocationProductionLineProductionLineSchema = exports.createLocationProductionLineSchema = exports.deleteLocationProductionLineSchema = void 0;
 ...
 * ------------------------------------------------------------------
 */
const getByLocationProductionLineIdLocationProductionLineSchema = zod_1.z.object({
    params: zod_1.z.object({ location_id: zod_1.z.string(), production_line_id: zod_1.z.string() }),
    query: zod_1.z.object({}).strict(),
    body: zod_1.z.object({}).strict(),
    response: location_production_line_model_schema_1.locationProductionLineReponseSchema.nullable(),
});
exports.getByLocationProductionLineIdLocationProductionLineSchema = getByLocationProductionLineIdLocationProductionLineSchema;
/**
