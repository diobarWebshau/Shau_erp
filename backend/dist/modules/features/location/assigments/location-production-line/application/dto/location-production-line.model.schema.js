...
exports.locationProductionLineUpdateSchema = exports.locationProductionLineReponseSchema = exports.locationProductionLineCreateSchema = void 0;
 ...
 */
const locationProductionLineCreateSchema = zod_1.z.object({
    location_id: zod_1.z.number().int(),
    production_line_id: zod_1.z.number().int()
});
exports.locationProductionLineCreateSchema = locationProductionLineCreateSchema;
/**
 * UpdateSchema
 * ------------------------------------------------------------------
...
exports.locationProductionLineUpdateSchema = locationProductionLineUpdateSchema;
/**
 * ResponseSchema
 * ------------------------------------------------------------------
...
exports.locationProductionLineReponseSchema = locationProductionLineReponseSchema;
