...
class LocationProductionLineController {
    ...
    constructor() {
        ...
        this.repoProductionLine = new production_line_repository_1.ProductionLineRepository();
        ...
        this.createUseCase = new create_location_production_line_usecase_1.CreateLocationProductionLineUseCase(this.repo, this.repoLocation, this.repoProductionLine);
        ...
        this.getByIdLocationProductionLine = new get_location_production_line_by_location_location_type_usecase_1.GetLocationProductionLineByIdLocationProductionLineUseCase(this.repo);
    }
    ;
    // ============================================================
    // GET ALL
    ...
    // GET BY ID
    // ============================================================
    getByIdLocationProductionLineId = async (req, res) => {
        const { location_id, production_line_id } = req.params;
        const result = await this.getByIdLocationProductionLine.execute(Number(location_id), Number(production_line_id));
        if (!result)
            return res.status(204).send(null);
        return res.status(200).send(result);
    };
