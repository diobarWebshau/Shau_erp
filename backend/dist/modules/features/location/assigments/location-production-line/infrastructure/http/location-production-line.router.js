 ...
 */
const locationProductionLineRouter = () => {
    const router = (0, express_1.Router)();
    const controller = new location_production_line_controller_1.default();
    router.get("/", (0, zod_middleware_1.validateRequest)(location_production_line_endpoint_schema_1.getAllLocationProductionLineProductionLineSchema), controller.getAll);
    router.get("/id/:id", (0, zod_middleware_1.validateRequest)(location_production_line_endpoint_schema_1.getByIdLocationProductionLineSchema), controller.getById);
    router.get("/location/:location_id/production-line/:production_line_id", (0, zod_middleware_1.validateRequest)(location_production_line_endpoint_schema_1.getByLocationProductionLineIdLocationProductionLineSchema), controller.getByIdLocationProductionLineId);
    router.post("/", (0, zod_middleware_1.validateRequest)(location_production_line_endpoint_schema_1.createLocationProductionLineSchema), controller.create);
    router.patch("/:id", (0, zod_middleware_1.validateRequest)(location_production_line_endpoint_schema_1.updateLocationProductionLineSchema), controller.update);
    router.delete("/:id", (0, zod_middleware_1.validateRequest)(location_production_line_endpoint_schema_1.deleteLocationProductionLineSchema), controller.delete);
    return router;
};
exports.locationProductionLineRouter = locationProductionLineRouter;
