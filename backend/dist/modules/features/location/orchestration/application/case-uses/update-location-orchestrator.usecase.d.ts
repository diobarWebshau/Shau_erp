...
import { LocationOrchestratorUpdateProps, LocationOrchestrator } from "../../domain/location-orchestrator.types";
...
export declare class UpdateLocationOrchestratorUseCase {
    ...
    execute: (id: number, data: LocationOrchestratorUpdateProps) => Promise<LocationOrchestrator>;
}
export {};
