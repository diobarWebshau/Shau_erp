...
const createLocationOrchestratorSchema = zod_1.z.object({
    ...
    body: location_orchestrator_model_schema_1.locationOrchestratorCreateRequestSchema,
    response: location_orchestrator_model_schema_1.locationOrchestratorResponseSchema
});
...
const updateLocationOrchestratorSchema = zod_1.z.object({
    ...
    query: zod_1.z.object({}).strict(),
    body: location_orchestrator_model_schema_1.locationOrchestratorUpdateRequestSchema,
    response: location_orchestrator_model_schema_1.locationOrchestratorResponseSchema
});
