 ...
 */
declare const productionLineProductCreateSchema: z.ZodObject<{
    product_id: z.ZodNumber;
    production_line_id: z.ZodNumber;
}, z.core.$strip>;
declare const productionLineProductUpdateSchema: z.ZodObject<{
    product_id: z.ZodOptional<z.ZodNumber>;
    production_line_id: z.ZodOptional<z.ZodNumber>;
}, z.core.$strip>;
declare const productionLineProductResponseSchema: z.ZodObject<{
    product_id: z.ZodNumber;
    production_line_id: z.ZodNumber;
    id: z.ZodNumber;
}, z.core.$strip>;
 ...
 */
type ProductionLineProductCreateDto = z.infer<typeof productionLineProductCreateSchema>;
type ProductionLineProductUpdateDto = z.infer<typeof productionLineProductUpdateSchema>;
type ProductionLineProductResponseDto = z.infer<typeof productionLineProductResponseSchema>;
export type { ProductionLineProductCreateDto, ProductionLineProductResponseDto, ProductionLineProductUpdateDto };
export { productionLineProductCreateSchema, productionLineProductResponseSchema, productionLineProductUpdateSchema };
