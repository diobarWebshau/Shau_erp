...
exports.GetAllProductionLineProductUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetAllProductionLineProductUseCase {
    repo;
    ...
    ;
    async execute(tx) {
        const plps = await this.repo.findAll(tx);
        return plps;
    }
    ;
}
exports.GetAllProductionLineProductUseCase = GetAllProductionLineProductUseCase;
