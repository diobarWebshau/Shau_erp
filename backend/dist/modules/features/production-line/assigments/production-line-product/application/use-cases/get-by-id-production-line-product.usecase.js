...
exports.GetByIdProductionLineProductUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetByIdProductionLineProductUseCase {
    repo;
    ...
    ;
    async execute(id, tx) {
        const plp = await this.repo.findById(id, tx);
        return plp;
    }
    ;
}
exports.GetByIdProductionLineProductUseCase = GetByIdProductionLineProductUseCase;
