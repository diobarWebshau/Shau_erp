 ...
 */
export declare class GetByProductionLineProductUseCase {
    private readonly repo;
    constructor(productionLineRepo: IProductionLineProductRepository);
    execute(production_line_id: number, product_id: number, tx?: Transaction): Promise<ProductionLineProductProps | null>;
}
