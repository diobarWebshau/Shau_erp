...
exports.GetByProductionLineProductUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetByProductionLineProductUseCase {
    repo;
    constructor(productionLineRepo) {
        this.repo = productionLineRepo;
    }
    ;
    async execute(production_line_id, product_id, tx) {
        const plp = await this.repo.findByProductionLineProduct(production_line_id, product_id, tx);
        return plp;
    }
    ;
}
exports.GetByProductionLineProductUseCase = GetByProductionLineProductUseCase;
