 ...
 */
export declare class UpdateProductionLineProductUseCase {
    private readonly repo;
    constructor(repo: IProductionLineProductRepository);
    execute(id: number, data: ProductionLineProductUpdateProps, tx?: Transaction): Promise<ProductionLineProductProps>;
}
