...
exports.UpdateProductionLineProductUseCase = void 0;
 ...
 */
class UpdateProductionLineProductUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    async execute(id, data, tx) {
        ...
        if (!existing)
            throw new http_error_1.default(404, "La asignación del producto a la línea de producción que se desea actualizar no fue posible encontrarla.");
        ...
        const normalizedExisting = (0, decimal_normalization_and_cleaning_utils_1.deepNormalizeDecimals)(existing, ["product_id", "production_line_id"]);
        const normalizedMerged = (0, decimal_normalization_and_cleaning_utils_1.deepNormalizeDecimals)(merged, ["product_id", "production_line_id"]);
        ...
        if (!updated)
            throw new http_error_1.default(500, "No fue posible actualizar la asignacion del producto a la línea de producción.");
        return updated;
    }
}
exports.UpdateProductionLineProductUseCase = UpdateProductionLineProductUseCase;
