import { ProductionLineProductCreateProps, ProductionLineProductProps, ProductionLineProductUpdateProps } from "./production-line-product.types";
 ...
 */
export interface IProductionLineProductRepository {
