...
type ProductionLineProductCreateAttributes = Omit<ProductionLineProductAttributes, "id">;
type ProductionLineProductUpdateAttributes = Partial<ProductionLineProductCreateAttributes>;
declare class ProductionLineProductModel extends Model<ProductionLineProductAttributes, ProductionLineProductCreateAttributes> {
    id: number;
    production_line_id: number;
    product_id: number;
    static getEditableFields: () => readonly (keyof ProductionLineProductUpdateAttributes)[];
    static getAllFields: () => readonly (keyof ProductionLineProductAttributes)[];
}
export { ProductionLineProductAttributes, ProductionLineProductCreateAttributes, ProductionLineProductUpdateAttributes };
export { ProductionLineProductModel };
