...
exports.GetAllProductDiscountRangeUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetAllProductDiscountRangeUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
...
exports.GetAllProductDiscountRangeUseCase = GetAllProductDiscountRangeUseCase;
