...
exports.GetProductDiscountRangeByIdUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetProductDiscountRangeByIdUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
...
exports.GetProductDiscountRangeByIdUseCase = GetProductDiscountRangeByIdUseCase;
;
