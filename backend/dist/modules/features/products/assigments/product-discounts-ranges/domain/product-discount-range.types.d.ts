...
interface ProductDiscountRangeProps {
    id: number;
    product_id: number;
    unit_price: DecimalVO;
    min_qty: DecimalVO;
    max_qty: DecimalVO;
    created_at: Date;
    updated_at: Date;
}
type ProductDiscountRangeCreateProps = Omit<ProductDiscountRangeProps, "id" | "created_at" | "updated_at">;
type ProductDiscountRangeUpdateProps = Partial<ProductDiscountRangeCreateProps>;
export type { ProductDiscountRangeProps, ProductDiscountRangeCreateProps, ProductDiscountRangeUpdateProps };
