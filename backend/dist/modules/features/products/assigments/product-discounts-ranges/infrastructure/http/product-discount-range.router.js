 ...
 */
const ProductDiscountRangeRouter = () => {
    const router = (0, express_1.Router)();
    const controller = new product_discount_range_controller_1.ProductDiscountRangeController();
    router.get("/", (0, zod_middleware_1.validateRequest)(product_discount_range_endpoint_schema_1.getAllProductDiscountRangeSchema), controller.getAll);
    router.get("/id/:id", (0, zod_middleware_1.validateRequest)(product_discount_range_endpoint_schema_1.getByIdProductDiscountRangeSchema), controller.getById);
    router.get("/product/:product_id", (0, zod_middleware_1.validateRequest)(product_discount_range_endpoint_schema_1.getByProductIdProductDiscountRangeSchema), controller.getByProductId);
    router.post("/", (0, zod_middleware_1.validateRequest)(product_discount_range_endpoint_schema_1.createProductDiscountRangeSchema), controller.create);
    router.patch("/:id", (0, zod_middleware_1.validateRequest)(product_discount_range_endpoint_schema_1.updateProductDiscountRangeSchema), controller.update);
    router.delete("/:id", (0, zod_middleware_1.validateRequest)(product_discount_range_endpoint_schema_1.deleteProductDiscountRangeSchema), controller.delete);
    return router;
};
exports.ProductDiscountRangeRouter = ProductDiscountRangeRouter;
