...
exports.GetProductInputProcessByIdUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetProductInputProcessByIdUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
...
exports.GetProductInputProcessByIdUseCase = GetProductInputProcessByIdUseCase;
;
