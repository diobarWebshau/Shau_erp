...
exports.getByIdProductInputProductInputSchema = exports.getByIdProductInputSchema = exports.updateProductInputSchema = exports.getAllProductInputSchema = exports.createProductInputSchema = exports.deleteProductInputSchema = void 0;
 ...
 * ------------------------------------------------------------------
 */
const getByIdProductInputProductInputSchema = zod_1.z.object({
    params: zod_1.z.object({ product_id: zod_1.z.string(), input_id: zod_1.z.string() }),
    query: zod_1.z.object({}).strict(),
    body: zod_1.z.object({}).strict(),
    response: product_input_model_schema_1.ProductInputReponseSchema.nullable(),
});
exports.getByIdProductInputProductInputSchema = getByIdProductInputProductInputSchema;
/**
