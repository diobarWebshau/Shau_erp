...
const product_input_endpoint_schema_1 = require("../../application/dto/product-input.endpoint.schema");
const product_input_controller_1 = require("./product-input.controller");
...
const ProductInputRouter = () => {
    ...
    const controller = new product_input_controller_1.ProductInputController();
    router.get("/", (0, zod_middleware_1.validateRequest)(product_input_endpoint_schema_1.getAllProductInputSchema), controller.getAll);
    router.get("/id/:id", (0, zod_middleware_1.validateRequest)(product_input_endpoint_schema_1.getByIdProductInputSchema), controller.getById);
    router.get("/product/:product_id/input/:input_id", (0, zod_middleware_1.validateRequest)(product_input_endpoint_schema_1.getByIdProductInputProductInputSchema), controller.getByIdProductInput);
    router.post("/", (0, zod_middleware_1.validateRequest)(product_input_endpoint_schema_1.createProductInputSchema), controller.create);
    router.patch("/:id", (0, zod_middleware_1.validateRequest)(product_input_endpoint_schema_1.updateProductInputSchema), controller.update);
    router.delete("/:id", (0, zod_middleware_1.validateRequest)(product_input_endpoint_schema_1.deleteProductInputSchema), controller.delete);
    return router;
};
