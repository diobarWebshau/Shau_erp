 ...
 * ------------------------------------------------------------------
 */
declare const getByIdProductProcessProductProcesSchema: z.ZodObject<{
    params: z.ZodObject<{
...
type GetByIdProductProcessProductProcesSchema = EndpointSchema<z.infer<typeof getByIdProductProcessProductProcesSchema>["params"], z.infer<typeof getByIdProductProcessProductProcesSchema>["body"], z.infer<typeof getByIdProductProcessProductProcesSchema>["query"], z.infer<typeof getByIdProductProcessProductProcesSchema>["response"]>;
export { deleteProductProcessSchema, createProductProcessSchema, getAllProductProcessSchema, updateProductProcessSchema, getByIdProductProcessSchema, getByIdProductProcessProductProcesSchema };
export type { CreateProductProcessSchema, GetAllProductProcesssSchema, GetByIdProductProcessSchema, UpdateProductProcessSchema, DeleteProductProcessSchema, GetByIdProductProcessProductProcesSchema };
