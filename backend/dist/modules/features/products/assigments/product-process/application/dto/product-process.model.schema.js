...
exports.ProductProcessUpdateSchema = exports.ProductProcessReponseSchema = exports.ProductProcessCreateSchema = void 0;
 ...
 */
const ProductProcessCreateSchema = zod_1.z.object({
    product_id: zod_1.z.number().int(),
    process_id: zod_1.z.number().int(),
    sort_order: zod_1.z.number().int()
});
exports.ProductProcessCreateSchema = ProductProcessCreateSchema;
/**
 * UpdateSchema
 * ------------------------------------------------------------------
 ...
 */
const ProductProcessUpdateSchema = ProductProcessCreateSchema.partial();
exports.ProductProcessUpdateSchema = ProductProcessUpdateSchema;
/**
 * ResponseSchema
 * ------------------------------------------------------------------
 ...
 */
const ProductProcessReponseSchema = ProductProcessCreateSchema.extend({
    id: zod_1.z.number().int(),
});
exports.ProductProcessReponseSchema = ProductProcessReponseSchema;
