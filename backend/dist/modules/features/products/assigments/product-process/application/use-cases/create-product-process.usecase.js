...
exports.CreateProductProcessUseCase = void 0;
 ...
 */
class CreateProductProcessUseCase {
    repo;
    repoProduct;
    repoProcess;
    constructor(repo, repoProduct, repoProcess) {
        this.repo = repo;
...
exports.CreateProductProcessUseCase = CreateProductProcessUseCase;
