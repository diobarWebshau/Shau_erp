...
exports.UpdateProductProcessUseCase = void 0;
 ...
 */
class UpdateProductProcessUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    async execute(id, data, tx) {
        ...
        if (!updated)
            throw new http_error_1.default(500, "No fue posible actualizar la asignacion del proceso al producto.");
        return updated;
    }
}
exports.UpdateProductProcessUseCase = UpdateProductProcessUseCase;
