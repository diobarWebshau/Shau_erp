...
import { CreateProductProcessSchema, DeleteProductProcessSchema, GetAllProductProcesssSchema, GetByIdProductProcessSchema, UpdateProductProcessSchema } from "../../application/dto/product-process.endpoint.schema";
/**
