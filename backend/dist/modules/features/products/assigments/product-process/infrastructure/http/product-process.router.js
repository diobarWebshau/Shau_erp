...
const ProductProcessRouter = () => {
    ...
    router.get("/product/:product_id/process/:process_id ", (0, zod_middleware_1.validateRequest)(product_process_endpoint_schema_1.getByIdProductProcessProductProcesSchema), controller.getByIdProductProcess);
