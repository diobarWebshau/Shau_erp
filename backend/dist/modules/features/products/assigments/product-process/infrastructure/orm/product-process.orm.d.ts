...
declare class ProductProcessModel extends Model<ProductProcessAttributes, ProductProcessCreateAttributes> {
    id: number;
    product_id: number;
    process_id: number;
    sort_order: number;
...
export type { ProductProcessAttributes, ProductProcessCreateAttributes };
