...
exports.GetByIdClientsQueryOrchestratorUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetByIdClientsQueryOrchestratorUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    async execute(id, tx) {
        const clientOrchestratorResponse = await this.repo.getByIdClientFullQuery(id, tx);
        if (!clientOrchestratorResponse)
            return null;
        const { addresses, discounts, ...client } = clientOrchestratorResponse;
...
exports.GetByIdClientsQueryOrchestratorUseCase = GetByIdClientsQueryOrchestratorUseCase;
;
