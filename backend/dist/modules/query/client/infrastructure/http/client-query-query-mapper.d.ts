import { GetAllClientFullQuerySchema } from "./../../application/dto/client-query.endpoint.schema";
 ...
 */
export declare const mapClientQueryToCriteria: (query: GetAllClientFullQuerySchema["query"]) => ClientSearchCriteria;
