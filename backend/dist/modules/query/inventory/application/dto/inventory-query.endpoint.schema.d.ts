 ...
 */
declare const getAllInventoryQuerySchema: z.ZodObject<{
 ...
 */
type GetAllInventoryQuerySchema = EndpointSchema<z.infer<typeof getAllInventoryQuerySchema>["params"], z.infer<typeof getAllInventoryQuerySchema>["body"], z.infer<typeof getAllInventoryQuerySchema>["query"], z.infer<typeof getAllInventoryQuerySchema>["response"]>;
type GetAllLikeToInventoryQuerySchema = EndpointSchema<z.infer<typeof getAllLikeToInventoryQuerySchema>["params"], z.infer<typeof getAllLikeToInventoryQuerySchema>["body"], z.infer<typeof getAllLikeToInventoryQuerySchema>["query"], z.infer<typeof getAllLikeToInventoryQuerySchema>["response"]>;
type GetByIdInventoryQuerySchema = EndpointSchema<z.infer<typeof getByIdInventoryQuerySchema>["params"], z.infer<typeof getByIdInventoryQuerySchema>["body"], z.infer<typeof getByIdInventoryQuerySchema>["query"], z.infer<typeof getByIdInventoryQuerySchema>["response"]>;
export { getAllInventoryQuerySchema, getAllLikeToInventoryQuerySchema, getByIdInventoryQuerySchema };
export type { GetAllInventoryQuerySchema, GetByIdInventoryQuerySchema, GetAllLikeToInventoryQuerySchema, };
