...
exports.GetAllLikeToInventoryQueryUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetAllLikeToInventoryQueryUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    ...
    execute = async (query, tx) => {
        const responseInventory = await this.repo.findAllLikeTo(query, tx);
        return responseInventory;
    };
}
exports.GetAllLikeToInventoryQueryUseCase = GetAllLikeToInventoryQueryUseCase;
;
