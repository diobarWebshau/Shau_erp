...
exports.GetByIdInventoryQueryUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetByIdInventoryQueryUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    ;
    execute = async (inventory_id, tx) => {
        const responseInventory = await this.repo.findByInventoryId(inventory_id, tx);
        return responseInventory;
    };
}
exports.GetByIdInventoryQueryUseCase = GetByIdInventoryQueryUseCase;
;
