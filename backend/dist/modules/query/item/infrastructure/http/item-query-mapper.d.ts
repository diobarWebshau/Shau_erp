import { GetAllItemQuerySchema } from "../../application/dto/item-query.endpoint.schema";
import type { ItemSearchCriteria } from "../../domain/item-query.types";
/**
 ...
 */
export declare const mapItemQueryToCriteria: (query: GetAllItemQuerySchema["query"]) => ItemSearchCriteria;
