...
const locationQueryResponseOrchestratorSchema = location_orchestrator_model_schema_1.locationOrchestratorResponseSchema;
...
const locationQueryResponseFullSchema = location_model_schema_1.locationResponseSchema.extend({
    location_production_lines: zod_1.default.array(location_orchestrator_model_schema_1.locationProductionLineOrchestratorResponseSchema),
    location_location_types: zod_1.default.array(location_orchestrator_model_schema_1.locationLocationTypeOrchestratorResponseSchema)
});
