...
exports.GetByIdLocationFullQueryUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetByIdLocationFullQueryUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
...
exports.GetByIdLocationFullQueryUseCase = GetByIdLocationFullQueryUseCase;
;
