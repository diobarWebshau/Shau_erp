...
exports.GetByIdLocationQueryOrchestratorUseCase = void 0;
/**
 * UseCase
 * ------------------------------------------------------------------
 ...
 */
class GetByIdLocationQueryOrchestratorUseCase {
    repo;
    constructor(repo) { this.repo = repo; }
    ;
    async execute(id, tx) {
        const locationResponse = await this.repo.getByIdLocationFullQuery(id, tx);
        if (!locationResponse)
            return null;
        const { location_location_types, location_production_lines, ...location } = locationResponse;
...
exports.GetByIdLocationQueryOrchestratorUseCase = GetByIdLocationQueryOrchestratorUseCase;
;
