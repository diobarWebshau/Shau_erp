...
import { ProductQueryDto, productQuerySchema } from "@modules/core/product/application/dto/product.model.schema";
import z from "zod";
...
export type { ProductQueryFullResponseDTO, ProductQueryOrchestorResponseDTO, ProductQueryDto };
