...
exports.GetByIdProductsQueryOrchestratorUseCase = void 0;
 ...
 */
class GetByIdProductsQueryOrchestratorUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    async execute(id, tx) {
        const productRecord = await this.repo.getByIdProductOrchestratorResult(id, tx);
        if (!productRecord)
            return null;
