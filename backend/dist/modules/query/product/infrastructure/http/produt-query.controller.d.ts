 ...
 */
export declare const mapProductQueryOrchestratorDomainToDto: (data: ProductOrchestrator) => Promise<ProductOrchestratorResponseProps>;
export declare const mapProductQueryFullDomainToDto: (data: ProductFullQueryResult) => Promise<ProductFullQueryResultDto>;
