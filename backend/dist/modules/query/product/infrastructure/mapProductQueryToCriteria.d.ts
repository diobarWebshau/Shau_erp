import { GetAllProductFullQuerySchema } from "../application/dto/product-query.endpoint.schema";
 ...
 */
export declare const mapProductQueryToCriteria: (query: GetAllProductFullQuerySchema["query"]) => ProductSearchCriteria;
