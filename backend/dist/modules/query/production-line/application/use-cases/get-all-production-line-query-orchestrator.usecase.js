...
exports.GetAllProductionLineQueryOrchestratorUseCase = void 0;
 ...
 */
class GetAllProductionLineQueryOrchestratorUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    ...
    async execute(query, tx) {
        ...
        const productionLineResults = productionLineReponses.map((pl) => {
            const { production_line_products, ...productionLine } = pl;
        ...
        return productionLineResults;
    }
    ;
}
exports.GetAllProductionLineQueryOrchestratorUseCase = GetAllProductionLineQueryOrchestratorUseCase;
;
