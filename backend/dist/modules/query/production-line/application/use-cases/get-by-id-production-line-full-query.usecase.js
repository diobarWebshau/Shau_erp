...
exports.GetByIdProductionLineFullQueryUseCase = void 0;
 ...
 */
class GetByIdProductionLineFullQueryUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
...
exports.GetByIdProductionLineFullQueryUseCase = GetByIdProductionLineFullQueryUseCase;
;
