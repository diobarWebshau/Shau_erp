...
exports.GetByIdProductionLineQueryOrchestratorUseCase = void 0;
 ...
 */
class GetByIdProductionLineQueryOrchestratorUseCase {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    ;
    async execute(id, tx) {
        const productionLineReponse = await this.repo.getByIdProductionLineFullQuery(id, tx);
        if (!productionLineReponse)
            return null;
        const { production_line_products, ...rest } = productionLineReponse;
...
exports.GetByIdProductionLineQueryOrchestratorUseCase = GetByIdProductionLineQueryOrchestratorUseCase;
;
