import { GetAllProductionLineOrchestratorSchema } from "./../../application/dto/production-line-query.endpoint.schema";
import type { ProductionLineSearchCriteria } from "../../domain/production-line-query.types";
/**
 ...
 */
export declare const mapProductionLineQueryToCriteria: (query: GetAllProductionLineOrchestratorSchema["query"]) => ProductionLineSearchCriteria;
