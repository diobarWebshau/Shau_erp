...
const defaultDiffOpts: DiffOpts = {
  nullUndefEqual: true,
...
function coerceNumberLike(value: unknown, enabled: boolean): unknown {
...
function normalizeArrayDiffById<TItem extends { id?: unknown }>(
...
interface ParentWithChildDiffSingle<
  TParent extends ObjectMap,
  TChild,
  ManagerKey extends string
> {
...
async function diffObjectArraysWithChildSingle<
  TParent extends ObjectMap,
  TChildKey extends keyof TParent,
  ManagerKey extends string
>(
...
interface ParentWithChildDiffMulti<
  TParent extends ObjectMap,
  ManagerKey extends string
> {
...
async function diffObjectArraysWithChildMulti<
  TParent extends ObjectMap,
  ManagerKey extends string
>(
  arr1: readonly TParent[],
...
// --------------------------------------------------------------
type ChildConfigRoot<TParent extends ObjectMap> =
  ChildConfig<
    TParent,
...
// --------------------------------------------------------------
async function diffObjectArraysWithChildren<
  TParent extends ObjectMap,
...
async function deepDiff(a: unknown, b: unknown, opts: DiffOpts = defaultDiffOpts) {
...
// ----------------------------------------
class ChildConfigRootBuilder<TParent extends ObjectMap> {
...
function createChildConfigRoot<TParent extends ObjectMap>() {
...
export {
  ...
  // Arrays
  diffObjectArrays,
  normalizeArrayDiffById,
  // Single child manager
  diffObjectArraysWithChildSingle,
  // Multi-manager
  diffObjectArraysWithChildMulti,
  // Multilevel manager
  diffObjectArraysWithChildren,
  // Builders
  createChildConfigRoot,
  ChildConfigRootBuilder,
  ChildConfigBuilder,
};
...
export type {
  ...
  MultiManagerConfig,
  ParentWithChildDiffMulti,
  ChildConfig,
  ChildConfigRoot,
  ParentWithChildrenDiff,
  ObjectMap,
  ChildOfParent,
};
