import {
    getAllClientsSchema, getByIdClientSchema,
    getByCompanyNameClientSchema, deleteClientSchema,
...
export const ClientRouter = (): Router => {
    ...
    router.get("/", validateRequest(getAllClientsSchema), controller.getAll);
    router.get("/id/:id", validateRequest(getByIdClientSchema), controller.getById);
    router.get("/company_name/:company_name", validateRequest(getByCompanyNameClientSchema), controller.getByCompanyName);
    router.post("/", validateRequest(createClientSchema), controller.create);
    router.patch("/:id", validateRequest(updateClientSchema), controller.update);
    router.delete("/:id", validateRequest(deleteClientSchema), controller.delete);
    return router;
}
