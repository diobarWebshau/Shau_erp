import {
    getAllinputTypeSchema, getByIdinputTypeSchema,
    getByNameinputTypeSchema, createinputTypeSchema,
...
export const InputTypeRouter = (): Router => {
    const router: Router = Router();
    const controller: InputTypeController = new InputTypeController();
    router.get("/", validateRequest(getAllinputTypeSchema), controller.getAll);
    router.get("/id/:id", validateRequest(getByIdinputTypeSchema), controller.getById);
    router.get("/name/:name", validateRequest(getByNameinputTypeSchema), controller.getByName);
    router.post("/", validateRequest(createinputTypeSchema), controller.create);
    router.patch("/:id", validateRequest(updateinputTypeSchema), controller.update);
    router.delete("/:id", validateRequest(deleteinputTypeSchema), controller.delete);
    return router;
}
