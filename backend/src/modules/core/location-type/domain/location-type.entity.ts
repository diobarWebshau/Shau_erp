import type { LocationTypeProps } from "./location-type.types";
...
export class LocationTypeEntity {
    private readonly props: LocationTypeProps;
    constructor(props: LocationTypeProps) {
        this.props = props;
    }
    get values(): LocationTypeProps {
        return this.props;
    }
}
