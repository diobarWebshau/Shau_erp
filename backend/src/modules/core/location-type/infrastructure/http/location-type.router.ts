import {
    getAllLocationTypeSchema, getByIdLocationTypeSchema,
    getByNameLocationTypeSchema, createLocationTypeSchema,
...
export const LocationTypeRouter = (): Router => {
    const router: Router = Router();
    const controller: LocationTypeController = new LocationTypeController();
    router.get("/", validateRequest(getAllLocationTypeSchema), controller.getAll);
    router.get("/id/:id", validateRequest(getByIdLocationTypeSchema), controller.getById);
    router.get("/name/:name", validateRequest(getByNameLocationTypeSchema), controller.getByName);
    router.post("/", validateRequest(createLocationTypeSchema), controller.create);
    router.patch("/:id", validateRequest(updateLocationTypeSchema), controller.update);
    router.delete("/:id", validateRequest(deleteLocationTypeSchema), controller.delete);
    return router;
}
