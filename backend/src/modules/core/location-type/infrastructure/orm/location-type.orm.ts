...
class LocationTypeModel extends Model<LocationTypeAttributes, LocationTypeCreationAttributes> {
    declare id: number;
    declare name: string;
    declare created_at: Date;
    declare updated_at: Date;
    static getAllFields = (): readonly (keyof LocationTypeAttributes)[] => ["id", "name", "created_at", "updated_at"];
    static getEditableFields = (): readonly (keyof LocationTypeAttributes)[] => ["name"];
}
