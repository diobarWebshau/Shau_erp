...
import {
    createLocationSchema, deleteLocationSchema, getAllLocationsSchema, getByCustomIdLocationSchema,
    getByIdLocationSchema, getByNameLocationSchema, updateLocationSchema
...
export const locationRouter = (): Router => {
    ...
    router.get("/", validateRequest(getAllLocationsSchema), controller.getAll);
    router.get("/id/:id", validateRequest(getByIdLocationSchema), controller.getById);
    router.get("/name/:name", validateRequest(getByNameLocationSchema), controller.getByName);
    router.get("/custom_id/:custom_id", validateRequest(getByCustomIdLocationSchema), controller.getByCustomId);
    router.post("/", validateRequest(createLocationSchema), controller.create);
    router.patch("/:id", validateRequest(updateLocationSchema), controller.update);
    router.delete("/:id", validateRequest(deleteLocationSchema), controller.delete);
    return router;
};
