...
class ProcessModel extends Model<ProcessAttributes, ProcessCreationAttributes> {
    declare id: number;
    declare name: string;
    declare description: string;
    declare created_at: Date;
    declare updated_at: Date;
    static getAllFields = (): readonly (keyof ProcessAttributes)[] => ["id", "name", "created_at", "updated_at"];
    static getEditableFields = (): readonly (keyof ProcessAttributes)[] => ["name"];
}
