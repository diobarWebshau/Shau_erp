import type { ProductionLineProps } from "./production-line.types";
...
export class ProductionLineEntity {
    private readonly props: ProductionLineProps;
    constructor(props: ProductionLineProps) {
        this.props = props;
    };
    get values(): ProductionLineProps {
        return this.props;
    }
};