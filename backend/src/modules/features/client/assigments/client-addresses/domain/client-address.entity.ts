import type { ClientAddressProps } from "./client-address.types";
...
export class ClientAddressEntity {
    private readonly props: ClientAddressProps;
    constructor(props: ClientAddressProps) {
        this.props = props;
    };
    get values(): ClientAddressProps {
        return this.props;
    }
};