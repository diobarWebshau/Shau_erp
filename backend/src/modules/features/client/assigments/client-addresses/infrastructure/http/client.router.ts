import {
    createClientAddressSchema, deleteClientAddressSchema, getAllClientAddressesSchema,
    getByClientIdClientAddressSchema, getByIdClientAddressSchema, updateClientAddressSchema
...
export const ClientAddressRouter = (): Router => {
    ...
    const controller: ClientAddressController = new ClientAddressController();
    router.get("/", validateRequest(getAllClientAddressesSchema), controller.getAll);
    router.get("/id/:id", validateRequest(getByIdClientAddressSchema), controller.getById);
    router.get("/client_id/:client_id", validateRequest(getByClientIdClientAddressSchema), controller.getByClientIdName);
    router.post("/", validateRequest(createClientAddressSchema), controller.create);
    router.patch("/:id", validateRequest(updateClientAddressSchema), controller.update);
    router.delete("/:id", validateRequest(deleteClientAddressSchema), controller.delete);
    return router;
}
