 ...
 */
const ProductDiscountClientUpdateSchema = ProductDiscountClientCreateSchema.partial();
 ...
 */
const ProductDiscountClientReponseSchema = ProductDiscountClientCreateSchema.extend({
    id: z.number().int(),
    created_at: z.string(), 
    updated_at: z.string(), 
});
...
export {
    ProductDiscountClientCreateSchema,
    ProductDiscountClientReponseSchema,
    ProductDiscountClientUpdateSchema
};

export type {
    ProductDiscountClientResponseDto,
    ProductDiscountClientCreateDto,
    ProductDiscountClientUpdateDto
};
