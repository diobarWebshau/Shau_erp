import type { ProductDiscountClientProps } from "./product-discount-client.types";
...
export class ProductDiscountClientEntity {
    private readonly props: ProductDiscountClientProps;
    constructor(props: ProductDiscountClientProps) {
        this.props = props;
    }
    get values(): ProductDiscountClientProps {
        return this.props;
    }
};
