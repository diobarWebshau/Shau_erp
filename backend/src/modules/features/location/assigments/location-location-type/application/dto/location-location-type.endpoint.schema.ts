import { locationLocationTypeCreateSchema, locationLocationTypeReponseSchema, locationLocationTypeUpdateSchema } from "./location-location-type.model.schema";
 ...
 * ------------------------------------------------------------------
 */
const getAllLocationLocationTypeSchema = z.object({
    params: z.object({}).strict(),
    query: z.object({}).strict(),
    body: z.object({}).strict(),
    response: z.array(locationLocationTypeReponseSchema),
});
 ...
 * ------------------------------------------------------------------
 */
const getByIdLocationLocationTypeSchema = z.object({
 ...
 * ------------------------------------------------------------------
 */
const createLocationLocationTypeSchema = z.object({
    params: z.object({}).strict(),
    query: z.object({}).strict(),
    body: locationLocationTypeCreateSchema,
    response: locationLocationTypeReponseSchema,
});
 ...
 * ------------------------------------------------------------------
 */
const updateLocationLocationTypeSchema = z.object({
    params: z.object({ id: z.string() }),
    query: z.object({}).strict(),
    body: locationLocationTypeUpdateSchema,
    response: locationLocationTypeReponseSchema,
});
 ...
 * ------------------------------------------------------------------
 */
const deleteLocationLocationTypeSchema = z.object({
    params: z.object({ id: z.string() }),
    query: z.object({}).strict(),
    body: z.object({}).strict(),
    response: z.null(),
...
type GetAllLocationLocationTypesSchema = EndpointSchema<
    z.infer<typeof getAllLocationLocationTypeSchema>["params"],
    z.infer<typeof getAllLocationLocationTypeSchema>["body"],
    z.infer<typeof getAllLocationLocationTypeSchema>["query"],
    z.infer<typeof getAllLocationLocationTypeSchema>["response"]
>;

type GetByIdLocationLocationTypeSchema = EndpointSchema<
    z.infer<typeof getByIdLocationLocationTypeSchema>["params"],
    z.infer<typeof getByIdLocationLocationTypeSchema>["body"],
    z.infer<typeof getByIdLocationLocationTypeSchema>["query"],
    z.infer<typeof getByIdLocationLocationTypeSchema>["response"]
>;

type CreateLocationLocationTypeSchema = EndpointSchema<
    z.infer<typeof createLocationLocationTypeSchema>["params"],
    z.infer<typeof createLocationLocationTypeSchema>["body"],
    z.infer<typeof createLocationLocationTypeSchema>["query"],
    z.infer<typeof createLocationLocationTypeSchema>["response"]
>;

type UpdateLocationLocationTypeSchema = EndpointSchema<
    z.infer<typeof updateLocationLocationTypeSchema>["params"],
    z.infer<typeof updateLocationLocationTypeSchema>["body"],
    z.infer<typeof updateLocationLocationTypeSchema>["query"],
    z.infer<typeof updateLocationLocationTypeSchema>["response"]
>;

type DeleteLocationLocationTypeSchema = EndpointSchema<
    z.infer<typeof deleteLocationLocationTypeSchema>["params"],
    z.infer<typeof deleteLocationLocationTypeSchema>["body"],
    z.infer<typeof deleteLocationLocationTypeSchema>["query"],
