 ...
 */
const locationLocationTypeCreateSchema = z.object({
...
export {
    locationLocationTypeCreateSchema,
    locationLocationTypeReponseSchema,
    locationLocationTypeUpdateSchema
};

export type {
    LocationLocationTypeResponseDto,
    LocationLocationTypeCreateDto,
    LocationLocationTypeUpdateDto
};
