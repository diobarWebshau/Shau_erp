...
export class LocationLocationTypeController {
    ...
    private readonly updateUseCase: UpdateLocationLocationTypeUseCase;
    private readonly deleteUseCase: DeleteLocationLocationTypeUseCase;
    ...
    // GET ALL
    // ============================================================
    getAll = async (_req: ApiRequest<GetAllLocationLocationTypesSchema>, res: ApiResponse<GetAllLocationLocationTypesSchema>) => {
        const result: LocationLocationTypeResponseDto[] = await this.getAllUseCase.execute();
    ...
    // CREATE
    // ============================================================
    create = async (req: ApiRequest<CreateLocationLocationTypeSchema>, res: ApiResponse<CreateLocationLocationTypeSchema>) => {
        const body: LocationLocationTypeCreateDto = req.body;
        const created: LocationLocationTypeResponseDto = await this.createUseCase.execute(body);
