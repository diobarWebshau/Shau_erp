 ...
 */
const locationProductionLineCreateSchema = z.object({
 ...
 */
const locationProductionLineUpdateSchema = locationProductionLineCreateSchema.partial();
 ...
 */
const locationProductionLineReponseSchema = locationProductionLineCreateSchema.extend({
    id: z.number().int(),
});
 ...
 */
type LocationProductionLineCreateDto = z.infer<typeof locationProductionLineCreateSchema>;
type LocationProductionLineResponseDto = z.infer<typeof locationProductionLineReponseSchema>;
type LocationProductionLineUpdateDto = z.infer<typeof locationProductionLineUpdateSchema>;

export {
    locationProductionLineCreateSchema,
    locationProductionLineReponseSchema,
    locationProductionLineUpdateSchema
};

export type {
    LocationProductionLineResponseDto,
    LocationProductionLineCreateDto,
    LocationProductionLineUpdateDto
};
