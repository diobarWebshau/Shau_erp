import type { LocationProductionLineProps } from "./location-production-line.types";
...
export class LocationProductionLineEntity {
    private readonly props: LocationProductionLineProps;
    constructor(props: LocationProductionLineProps) {
        this.props = props;
    }
    get values(): LocationProductionLineProps {
        return this.props;
    }
};
