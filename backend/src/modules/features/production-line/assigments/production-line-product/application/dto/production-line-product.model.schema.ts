...
const productionLineProductCreateSchema = z.object({
    product_id: z.number(),
...
export type {
    ProductionLineProductCreateDto,
    ProductionLineProductResponseDto,
    ProductionLineProductUpdateDto
};

export {
    productionLineProductCreateSchema,
    productionLineProductResponseSchema,
    productionLineProductUpdateSchema
}