...
export class GetByIdProductionLineProductUseCase {
    ...
    async execute(id: number, tx?: Transaction) {
        const plp: ProductionLineProductProps | null = await this.repo.findById(id, tx);
        return plp;
    };
}