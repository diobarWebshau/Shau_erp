...
class ProductionLineProductModel extends Model<ProductionLineProductAttributes, ProductionLineProductCreateAttributes> {
...
export {
    ...
    ProductionLineProductUpdateAttributes
}
