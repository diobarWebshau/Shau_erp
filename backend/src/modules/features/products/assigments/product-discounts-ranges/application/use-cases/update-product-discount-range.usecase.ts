...
export class UpdateProductDiscountRangeUseCase {
    ...
    async execute(id: string, data: ProductDiscountRangeUpdateProps): Promise<ProductDiscountRangeProps> {
        ...
        const normalizedExisting: ProductDiscountRangeUpdateProps = deepNormalizeDecimals<ProductDiscountRangeUpdateProps>(existing, ["unit_price", "max_qty", "max_qty"]);
