import type { ProductDiscountRangeProps } from "./product-discount-range.types";
...
export class ProductDiscountRangeEntity {
    private readonly props: ProductDiscountRangeProps;
    constructor(props: ProductDiscountRangeProps) {
        this.props = props;
    }
    get values(): ProductDiscountRangeProps {
        return this.props;
    }
};
