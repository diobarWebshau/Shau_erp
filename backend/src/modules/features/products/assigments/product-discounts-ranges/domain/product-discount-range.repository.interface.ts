...
export interface IProductDiscountRangeRepository {
    findAll(tx?: Transaction): Promise<ProductDiscountRangeProps[]>;
    findById(id: number, tx?: Transaction): Promise<ProductDiscountRangeProps | null>;
    findByProductId(product_id: number, tx?: Transaction): Promise<ProductDiscountRangeProps[]>;
