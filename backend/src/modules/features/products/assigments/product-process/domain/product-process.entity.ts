import type { ProductProcessProps } from "./product-process.types";
...
export class ProductProcessEntity {
    private readonly props: ProductProcessProps;
    constructor(props: ProductProcessProps) {
        this.props = props;
    }
    get values(): ProductProcessProps {
        return this.props;
    }
};
