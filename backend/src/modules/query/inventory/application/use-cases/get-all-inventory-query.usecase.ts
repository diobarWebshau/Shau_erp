...
export class GetAllInventoryQueryUseCase {
    ...
    execute = async (tx?: Transaction): Promise<InventoryQueryProps[]> => {
        const responseInventory: InventoryQueryProps[] = await this.repo.findAll(tx);
