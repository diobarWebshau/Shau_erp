...
export class GetAllLikeToInventoryQueryUseCase {
    ...
    execute = async (query: InventorySearchQueryProp, tx?: Transaction): Promise<InventoryQueryProps[]> => {
        const responseInventory: InventoryQueryProps[] = await this.repo.findAllLikeTo(query, tx);
