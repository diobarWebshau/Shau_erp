import { ItemQueryProps } from "./item-query.types";
...
export interface IItemQueryRepository {
    getAllItems(): Promise<ItemQueryProps[]>,
    getByIdItem(id: number): Promise<ItemQueryProps | null>,
};