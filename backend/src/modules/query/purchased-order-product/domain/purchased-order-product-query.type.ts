...
export type {
    AppliedProductDiscountRangeQueryProps,
    AppliedProductDiscountClientQueryProps,
    PurchasedOrderProductQueryProps,

    AppliedProductDiscountRangeQueryResponseProps,
    AppliedProductDiscountClientQueryResponseProps,
