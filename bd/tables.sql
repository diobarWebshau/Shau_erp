...
DROP DATABASE IF EXISTS brgb5sc7hqlfhh7m;
CREATE DATABASE brgb5sc7hqlfhh7m;
...
CREATE TABLE items (
    ...
    item_id INT NOT NULL,
    PRIMARY KEY(id),
    CONSTRAINT uq_item UNIQUE (item_type, item_id)
);

/* EMPLEADO PARA PRUEBAS IGNORAR */
INSERT INTO operations(name) VALUES ('create'),('update'),('delete');
