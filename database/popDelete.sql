...
BEGIN
    ...
    DECLARE v_stock_fix_qty DECIMAL(14,4) DEFAULT 0.00;
    ...
    IF v_inventory_allocation > 0 THEN
        IF v_production_allocation > 0 THEN
            ...
            -- Establecemos la cantidad de producto a descomprometer de stock
            SET v_stock_fix_qty = -v_inventory_allocation;

            -- Efectuamos el movimiento para descomprometer el inventario del producto en stock 
            INSERT INTO inventory_movements (
                ...
                'Adjust Inventory Allocation', v_stock_fix_qty,
                'Order', in_pop_id, 1
            );
            ...
            INSERT INTO inventory_movements (
                ...
                v_location_name, v_location_id, 'product',
                in_product_id, in_product_name, 'allocate', 
                'Adjust Production Allocation', v_prod_fix_qty,
